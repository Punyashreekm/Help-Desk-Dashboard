...
export function TicketDetailsPanel() {
  return (
    <div className="flex h-full flex-col gap-4">
      <div>
        <p className="text-xs font-semibold uppercase text-muted-foreground">Ticket Details</p>
      ...
      <Card className="space-y-4 p-4">
        ...
        <div className="space-y-2">
          <p className="text-xs font-semibold text-muted-foreground">Ticket Type</p>
